    ...
    public CommandLineRunner loadData(AuthorRepository authorRepository,
        ...
        return args -> {
            ...
            List<Author> authors = List.of(
                new Author("J.K. Rowling", "British", 1965, "Author of the Harry Potter series."),
                new Author("George Orwell", "British", 1903, "Famous for 1984 and Animal Farm."),
                ...
                new Author("Mark Twain", "American", 1835, "Author of Adventures of Huckleberry Finn."),
                new Author("Leo Tolstoy", "Russian", 1828, "Author of War and Peace and Anna Karenina."),
                new Author("Gabriel Garcia Marquez", "Colombian", 1927, "Nobel laureate, magical realism pioneer."),
                new Author("Ernest Hemingway", "American", 1899, "Famous for The Old Man and the Sea."),
                new Author("Agatha Christie", "British", 1890, "Queen of mystery novels."),
                new Author("Fyodor Dostoevsky", "Russian", 1821, "Author of Crime and Punishment.")
            );
